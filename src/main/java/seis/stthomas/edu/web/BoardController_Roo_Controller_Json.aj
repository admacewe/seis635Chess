...
privileged aspect BoardController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> BoardController.showJson(@PathVariable("id") Long id) {
        ...
        return new ResponseEntity<String>(board.toJson(), headers, HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> BoardController.updateFromJson(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        Board board = Board.fromJsonToBoard(json);
        if (board.merge() == null) {
    ...
    public ResponseEntity<String> BoardController.updateFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        for (Board board: Board.fromJsonArrayToBoards(json)) {
            if (board.merge() == null) {
